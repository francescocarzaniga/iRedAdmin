...
def add(domain, form, conn=None):
    ...
    try:
        ...
        ldap_lib_general.change_password(dn_user, old_password=None, new_password=passwd_plain, conn=conn)
...
def update(profile_type, mail, form, conn=None):
    ...
    try:
        ...
        ldap_lib_general.change_password(dn_user, old_password=None, new_password=passwd, conn=conn)
